...
calculo_edad = anio_nacimiento - anio_auxiliar # Calculo la edad del usuario en el año ingresado.
...
""" 
 ...
 """
# Implementación:
def cocatenar_texto_con_numero (texto, numero): # Defino el encabezado de la función.
